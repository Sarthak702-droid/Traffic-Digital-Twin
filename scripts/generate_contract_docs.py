...
for name,message in messages.items():
    ...
    for f in message.fields:
        ...
        optional=f.containing_oneof is not None
    ...
    schemas[name]={'type':'object','properties':props,'additionalProperties':False,'required':[f.name for f in message.fields if f.containing_oneof is None]}
