...
func (c *simulationClient) ApplyPlan(ctx context.Context, in *PlanCommand, opts ...grpc.CallOption) (*ValidationResult, error) {
	...
	err := c.cc.Invoke(ctx, Simulation_ApplyPlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Simulation_ApplyPlan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(SimulationServer).ApplyPlan(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Simulation_ApplyPlan_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimulationServer).ApplyPlan(ctx, req.(*PlanCommand))
	}
	return interceptor(ctx, in, info, handler)
}
...
const (
	...
	Intelligence_Analyze_FullMethodName       = "/traffic.v1.Intelligence/Analyze"
	Intelligence_Compare_FullMethodName       = "/traffic.v1.Intelligence/Compare"
)
...
type IntelligenceClient interface {
	...
	Analyze(ctx context.Context, in *TrafficState, opts ...grpc.CallOption) (*Analysis, error)
	Compare(ctx context.Context, in *CompareCommand, opts ...grpc.CallOption) (*ComparisonResult, error)
}
...
func (c *intelligenceClient) Analyze(ctx context.Context, in *TrafficState, opts ...grpc.CallOption) (*Analysis, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Analysis)
	err := c.cc.Invoke(ctx, Intelligence_Analyze_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intelligenceClient) Compare(ctx context.Context, in *CompareCommand, opts ...grpc.CallOption) (*ComparisonResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ComparisonResult)
	err := c.cc.Invoke(ctx, Intelligence_Compare_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IntelligenceServer interface {
	...
	Analyze(context.Context, *TrafficState) (*Analysis, error)
	Compare(context.Context, *CompareCommand) (*ComparisonResult, error)
...
func (UnimplementedIntelligenceServer) Analyze(context.Context, *TrafficState) (*Analysis, error) {
	return nil, status.Error(codes.Unimplemented, "method Analyze not implemented")
}
func (UnimplementedIntelligenceServer) Compare(context.Context, *CompareCommand) (*ComparisonResult, error) {
...
func _Intelligence_Analyze_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TrafficState)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntelligenceServer).Analyze(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Intelligence_Analyze_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntelligenceServer).Analyze(ctx, req.(*TrafficState))
	}
	return interceptor(ctx, in, info, handler)
}

func _Intelligence_Compare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CompareCommand)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntelligenceServer).Compare(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Intelligence_Compare_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntelligenceServer).Compare(ctx, req.(*CompareCommand))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Intelligence_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Analyze",
			Handler:    _Intelligence_Analyze_Handler,
		},
		{
			MethodName: "Compare",
			Handler:    _Intelligence_Compare_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "twin.proto",
